  ...
  <div class="intro-wrapper">
    <div class="intro-text two-columns">
      ...
      <div class="column">
        ...
        <p>Btw, one of the things I built was an AI voice agent called Ms. Florentina, designed to help people identify project ideas. If you'd like to simplify some aspects of your life, or just see what talking to a robot is like, how about <a href="/ms-florentina">giving it a call</a>?</p>
