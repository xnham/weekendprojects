  ...
  <div class="intro-wrapper">
    <div class="intro-text two-columns">
      ...
      <div class="column">
        ...
        <p>Btw, one of the things I built was an AI voice agent called Ms. Florentina. If you'd like to uncover time-saving opportunities in your life or just see what it's like to talk to a robot, how about <a href="/ms-florentina">giving it a call</a>?</p>
