  ...
  <div class="intro-wrapper">
    <div class="intro-text two-columns">
      ...
      <div class="column">
        ...
        <p>Btw, one of the things I made was an AI voice agent called Sunny, designed to help spark project ideas. If you'd love to streamline some aspects of your life, or just see what talking to a robot is like, how about <a href="/sunny">giving it a call</a>?</p>
